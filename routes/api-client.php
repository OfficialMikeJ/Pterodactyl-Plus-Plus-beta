...
// Touch Down Hosting — themes, trophies & billing.
Route::get('/themes', Client\ThemeController::class)->name('api:client.themes');

Route::prefix('/billing')->group(function () {
    Route::get('/', [Client\BillingController::class, 'index'])->name('api:client.billing');
    Route::put('/settings', [Client\BillingController::class, 'updateSettings']);
...
Route::prefix('/account')->middleware(AccountSubject::class)->group(function () {
    ...
    Route::prefix('/trophies')->group(function () {
        Route::get('/', [Client\TrophyController::class, 'index'])->name('api:client.account.trophies');
        Route::get('/unseen', [Client\TrophyController::class, 'unseen']);
        Route::post('/seen', [Client\TrophyController::class, 'markSeen']);
    });
